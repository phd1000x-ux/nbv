...
<p align="center">
  ...
  <a href="#설치"><img src="https://img.shields.io/badge/platforms-macOS%20%7C%20Linux%20%7C%20Windows-blue" alt="platforms: macOS | Linux | Windows"></a>
...
- **크로스플랫폼.** macOS(Apple Silicon), Linux(x86_64 + ARM64), 그리고 **이제 Windows**까지 — 단일 정적 바이너리 하나. `cargo install nbv` 또는 Releases의 prebuilt로.
...
v0.7 미지원: 수식(LaTeX), 인터랙티브 위젯, JPEG/SVG 이미지, application/json pretty-print.
...
| Windows cmd.exe | ✓ (VT 자동 활성화) | placeholder |
