...
```bash
curl -L https://github.com/phd1000x-ux/nbv/releases/latest/download/nbv-v0.3.0-aarch64-apple-darwin.tar.gz \
...
```bash
curl -L https://github.com/phd1000x-ux/nbv/releases/latest/download/nbv-v0.3.0-x86_64-unknown-linux-musl.tar.gz \
  | tar -xz -C /usr/local/bin
```
